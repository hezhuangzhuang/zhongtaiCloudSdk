...
//                setLocalVideoDisplayRotation(1, windowsDisplayRotation);
                ...
                switch (lastOrientation) {
                    ...
                    case ORIENTATION_PORTRAIT_UP:
                        ...
                        // 1表示前置摄像头,//设置摄像头采集方向
                        setCaptureRotation(1, 3);
                        //近端画面显示角度
                        setLocalVideoDisplayRotation(1, 3);
                        //远端画面始终横屏
                        windowsDisplayRotation = 0;
                        break;
                    ...
                    case ORIENTATION_PORTRAIT_DOWN:
                        ...
                        // 1表示前置摄像头,//设置摄像头采集方向
                        setCaptureRotation(1, 1);
                        //近端画面显示角度
                        setLocalVideoDisplayRotation(1, 1);
                        //远端画面始终横屏
                        windowsDisplayRotation = 0;
                        break;
                    ...
                    case ORIENTATION_LANDSCAPE_RIGHT:
                        ...
                        //近端画面显示角度
                        setLocalVideoDisplayRotation(1, 2);
                        //远端画面始终横屏
                        windowsDisplayRotation = 0;
                        break;
...
//                setLocalVideoDisplayRotation(0, windowsDisplayRotation);
                ...
                switch (lastOrientation) {
                    ...
                    case ORIENTATION_PORTRAIT_UP:
                        ...
                        // 1表示前置摄像头,//设置摄像头采集方向
                        setCaptureRotation(0, 2);//3:倒立
                        //近端画面显示角度
                        setLocalVideoDisplayRotation(0, 2);//3:倒立
                        //远端画面始终横屏
                        windowsDisplayRotation = 0;
                        break;
                    ...
                    case ORIENTATION_PORTRAIT_DOWN:
                        ...
                        // 1表示前置摄像头,//设置摄像头采集方向
                        setCaptureRotation(0, 0);//1：屏幕倒立
                        //近端画面显示角度
                        setLocalVideoDisplayRotation(0, 0);//1：屏幕倒立
                        //远端画面始终横屏
                        windowsDisplayRotation = 0;
                        break;
                    ...
                    case ORIENTATION_LANDSCAPE_RIGHT:
                        ...
                        // 1表示前置摄像头,//设置摄像头采集方向
                        setCaptureRotation(0, 2);
                        //近端画面显示角度
                        setLocalVideoDisplayRotation(0, 2);
                        //远端画面始终横屏
                        windowsDisplayRotation = 0;
                        break;
