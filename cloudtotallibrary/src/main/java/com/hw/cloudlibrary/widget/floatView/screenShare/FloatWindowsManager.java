package com.hw.cloudlibrary.widget.floatView.screenShare;
...
import com.hw.cloudlibrary.widget.floatView.annotation.AnnotationWinManager;
import com.hw.cloudlibrary.widget.floatView.screenShare.rom.HuaweiUtils;
import com.hw.cloudlibrary.widget.floatView.screenShare.rom.MeizuUtils;
import com.hw.cloudlibrary.widget.floatView.screenShare.rom.MiuiUtils;
import com.hw.cloudlibrary.widget.floatView.screenShare.rom.OppoUtils;
import com.hw.cloudlibrary.widget.floatView.screenShare.rom.RomUtils;
...
public class FloatWindowsManager {
    ...
    public void createScreenShareFloatWindow(Context context) {
        ...
        int marginLeft = context.getResources().getDimensionPixelSize(R.dimen.dp15);
        int marginBottom = context.getResources().getDimensionPixelSize(R.dimen.dp162);
