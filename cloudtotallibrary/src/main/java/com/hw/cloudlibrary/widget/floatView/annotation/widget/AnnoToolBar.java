package com.hw.cloudlibrary.widget.floatView.annotation.widget;
...
public class AnnoToolBar extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        int popupWinHeight = mContext.getResources().getDimensionPixelSize(R.dimen.dp120) + mContext.getResources().getDimensionPixelSize(R.dimen.dp12);
        int popupwinWidth = mContext.getResources().getDimensionPixelSize(R.dimen.dp40);
    ...
    private void updateSelectColor(int color) {
        ...
        penWidth = (getResources().getDimensionPixelSize(R.dimen.dp6) * 1440 / LayoutUtil.getScreenDensityDpi());
        // 共享类型的切换
        MeetingMgr.getInstance().setAnnotationPen(currentPenColor, penWidth);
    }
    ...
    public void resetToolbarPosition() {
        ...
        if (viewWidth == 0 || ViewHeight == 0) {
            viewWidth = getResources().getDimensionPixelSize(R.dimen.dp340);
            ViewHeight = getResources().getDimensionPixelSize(R.dimen.dp48);
        }
        float newX = (parentWidth - viewWidth) / (float) 2;
        int bottom = getResources().getDimensionPixelSize(R.dimen.dp30);
