package com.hw.cloudlibrary.widget.floatView.util;
...
//            type = WindowManager.LayoutParams.TYPE_TOAST;
    ...
    public static int getRealWindowWidth() {
        WindowManager mWindowManager = (WindowManager) LocContext.getContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getNavigationBarHeight() {
        ...
        try {
            ...
            int x = (Integer) field.get(o);
            return LocContext.getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e) {
            LogUtil.e(TAG, "getStatusBarHeight exception.");
        }
