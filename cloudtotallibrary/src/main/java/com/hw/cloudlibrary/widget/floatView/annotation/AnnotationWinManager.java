...
import com.hw.cloudlibrary.widget.floatView.annotation.common.AnnotationConstants;
import com.hw.cloudlibrary.widget.floatView.annotation.common.AnnotationHelper;
import com.hw.cloudlibrary.widget.floatView.annotation.widget.DragToolbarView;
import com.hw.cloudlibrary.widget.floatView.annotation.widget.ToolbarButton;
import com.hw.cloudlibrary.widget.floatView.annotation.widget.adapter.ColorPickAdapter;
...
public class AnnotationWinManager implements View.OnClickListener {
    ...
    private final Context mContext = LocContext.getContext();
    ...
    private void addAnnotationToolbarView() {
        ...
        mToolbarLayoutParams.width = mContext.getResources().getDimensionPixelSize(R.dimen.dp340);
        mToolbarLayoutParams.height = mContext.getResources().getDimensionPixelSize(R.dimen.dp48);
        int marginLeft = (mScreenWidth - mToolbarLayoutParams.width) / 2;
        int marginBottom = mContext.getResources().getDimensionPixelSize(R.dimen.dp30) + mToolbarLayoutParams.height;
    ...
    private void addColorPickView() {
        ...
        mColorPickWindowParams.width = mContext.getResources().getDimensionPixelSize(R.dimen.dp40);
        mColorPickWindowParams.height = mContext.getResources().getDimensionPixelSize(R.dimen.dp120) + mContext.getResources().getDimensionPixelSize(R.dimen.dp8);
    ...
    private void updateSelectColor(int color) {
        ...
        int penWidth = (LocContext.getResources().getDimensionPixelSize(R.dimen.dp6) * 1440 / LayoutUtil.getScreenDensityDpi());
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.float_anno_color) {
            ...
            FloatWindowsManager.getInstance().createScreenShareFloatWindow(LocContext.getContext());
        }
