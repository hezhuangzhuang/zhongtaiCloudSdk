...
public class DragFloatActionButton extends FloatingActionButton {
    ...
    private void init() {
        ...
        mAnnoToolbarHeight = getResources().getDimensionPixelSize(R.dimen.dp50);
    }
    ...
    public void resetAnnotBtnPosition() {
        float newX = getResources().getDimensionPixelSize(R.dimen.dp10);
        int bottom = getResources().getDimensionPixelSize(R.dimen.dp65);
        View viewParent = (View) getParent();
        int parentHeight = viewParent.getHeight();
