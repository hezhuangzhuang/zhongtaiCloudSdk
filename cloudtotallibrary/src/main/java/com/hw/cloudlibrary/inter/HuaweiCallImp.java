...
//            PreferencesHelper.saveData(UIConstants.IS_AUTO_ANSWER, true);
    ...
    public int createConf(
        ...
        bookConfInfo.setSubject("APP_ANDROID_" + confName);
    ...
    public long joinConf(String confId,
        ...
        int result = MeetingMgr.getInstance().joinConf(confJoinParam, true, LoginMgr.getInstance().getTerminal());
        return result;
    }
     ...
     * @return
     */
    public long joinConferenceByAnonymous(String confId, String confPwd) {

        int result = MeetingMgr.getInstance().joinConferenceByAnonymous(
                confId,
                LoginMgr.getInstance().getTerminal(),
                confPwd,
                Constants.UPORTAL_REGISTER_SERVER,
                Constants.UPORTAL_PORT,
                false);
        return result;
    }
}
